#code that performs the MAIN FUNCTIONALITY- detects blinks, left right up down mouse movement and also clicks- but problem with clicking....check it
#This code performs the main function of controling the cursor and clicking
#This program should run on any OS provided that you have the necessary python packages
#I wrote and ran the code on Ubuntu
